                ...
                <div class="lstChoose">
                    <ul>
                        ...
                        @else
                            ...
                            @if(Request::get('attr_3')) <li><a href="{{ request()->fullUrlWithQuery(['attr_3'=> Request::get('attr_3')]) }}" class="js-param-search {{ Request::get('attr_3')  ? 'active_filter' : '' }}" data-param="attr_3={{Request::get('attr_3')}}" title="Kích cỡ">Kích cỡ<span class="icon"><i class="fas fa-times"></i></span></a></li> @endif
